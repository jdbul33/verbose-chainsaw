...
for i, d in enumerate(list(df_6['Dept'].unique())):
    ...
    if d == 'Water Works':
        ...
        p8.asterisk(x='Seconds', y='Count', source=y, color=color, size=12, alpha=0.75, legend= d)
        ...
        p8.circle_cross(x='Seconds', y='Count', source=y, color=color, size=12, alpha=0.75, legend= d)
...
output_file('311_Call_Center_Dashboard_Modified.html', title='311 Call Center Dashboard')
show(column(g,h,j,k))
